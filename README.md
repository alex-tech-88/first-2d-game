...
Control a fearless archer as he:
...
Your goal is to survive the level, avoid falling into hazards, and reach the end safely.
...
scenes/ — game scenes (player, enemies, platforms, main game)
